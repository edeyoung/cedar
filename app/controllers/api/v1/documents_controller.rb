module API
  module V1
    class DocumentsController < API::V1::BaseController
      ...
      EOS
      def show
        # Get the id-th document of the test execution.
        # Note that the :id of documents are sequential within their test, but NOT globally unique.
      ...
      param :actual_result, %w(accept reject),
            ...
            required: true
      def update
        # Only accept actual_result param, nothing else in document is mutable
